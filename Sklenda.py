                ...
                if game_state == 1 or game_state == 3:
                    if get_tile_clicked2(event.pos[0], event.pos[1]) != (None, None):
                        ...
                        if icons2[tile_x][tile_y][0] != None:
                            shape, color, point, size = icons2[tile_x][tile_y][0], icons2[tile_x][tile_y][1], \
                            icons2[tile_x][tile_y][2], icons2[tile_x][tile_y][3]
...
def draw_icon(list, tile_x, tile_y):
    shape, color, point, size = list[tile_x][tile_y][0], list[tile_x][tile_y][1], list[tile_x][tile_y][2], \
    list[tile_x][tile_y][3]
    left, top = get_left_top_of_tile(tile_x, tile_y)
    if shape == CIRCLE:
        center_point = (left + 40, top + 40)
        if size == SMALL:
